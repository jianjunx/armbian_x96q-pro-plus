...
set -euo pipefail
baseline=be1028ce193f0948f0476c03851a6a6da82ce5b4cf40d83c1c472cc47b9b2567
node=/soc/mmc@4021000
dtb=/boot/dtb/allwinner/sun55i-h728-x96qpro+.dtb
recovery=/boot/h728-wifi-clock12-v1-recovery
tmp=
...
make_candidate() {
    ...
    fdtput -t i "$2" "$node" max-frequency 25000000
...
[[ $mode == arm || $mode == restore ]] || die 'Usage: bash h728-wifi-sdio-test.sh arm|restore'
